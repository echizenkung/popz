          ...
          <div class="min-h-full menu w-80 bg-base-200 text-base-content">
            <div v-for="(item, index) in chat" :key="index">
              <div
                ...
                v-if="item.publisher != pubnub.getUUID()"
              >
            ...
            <div
              class="fixed flex justify-between w-full p-2 bg-violet-100"
              style="bottom: 0px"
            >
      ...
      <div class="container py-2 mx-auto lg:w-[60%] md:w-[100%]">
        ...
        <div class="flex justify-center mt-4">
          <div class="text-center lg:w-[50%] md:w=[100%]">
            <p>
              สัญลักษณ์และรูปภาพต่างๆบนเว็บไซต์ POPSLOTS.com
              ถือเป็นทรัพย์สินทางปัญญา ห้ามมิให้มีการคัดลอก ดัดแปลง ทำซ้ำ แก้ไข
